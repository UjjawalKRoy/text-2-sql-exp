emp_profile_few_shots = [
    ...
    },
    {
        ...
        "SQLQuery": "SELECT c.first_name, c.last_name, ji.start_date_time FROM job_interview ji LEFT JOIN candidates c ON ji.candidate = c.id WHERE DATE(ji.start_date_time) = CURDATE() + INTERVAL 1 DAY;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "How many interviews have been conducted by the employee with employee_code 'MI-516'?",
        "SQLQuery": "SELECT COUNT(*) AS total_interviews FROM job_interview ji WHERE ji.scheduled_by = (SELECT id FROM employee WHERE employee_code = 'MI-516');",
        "SQLResult": "",
        "Answer": "",
    },
    {
    ...
    },
    {
        ...
        "SQLQuery": "SELECT COUNT(*) AS total_interviews FROM job_interview ji LEFT JOIN candidates c ON ji.candidate = c.id WHERE c.city LIKE '%Ahmedabad%';",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "What are the details of employees who have scheduled job interviews and their corresponding candidate details?",
        "SQLQuery": "SELECT e.first_name AS employee_first_name, e.last_name AS employee_last_name, c.first_name AS candidate_first_name, c.last_name AS candidate_last_name, ji.start_date_time FROM job_interview ji INNER JOIN employee e ON ji.scheduled_by = e.id INNER JOIN candidates c ON ji.candidate = c.id;",
        "SQLResult": "",
        "Answer": "",
    },
    {
    ...
    },
    {
        ...
        "SQLQuery": "SELECT c.first_name, c.last_name, ji.start_date_time FROM job_interview ji LEFT JOIN candidates c ON ji.candidate = c.id LEFT JOIN employee e ON FIND_IN_SET(e.id, ji.interviewers) > 0 WHERE e.id IS NULL;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        ...
        "SQLQuery": "SELECT j.job_title, e.first_name, e.last_name, e.email_id FROM job_interview ji INNER JOIN employee e ON FIND_IN_SET(e.id, ji.interviewers) > 0 INNER JOIN jobs j ON ji.job = j.id;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "Who is Vatsal's reporting manager?",
        "SQLQuery": "SELECT m.first_name AS manager_first_name, m.last_name AS manager_last_name FROM employee e JOIN employee m ON e.reporting_to = m.id WHERE e.first_name = 'Vatsal';",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "How many invoices were sent in the last month?",
        "SQLQuery": "SELECT COUNT(*) AS total_invoices_sent FROM invoice WHERE DATE_FORMAT(createdAt, '%Y-%m') = DATE_FORMAT(CURDATE() - INTERVAL 1 MONTH, '%Y-%m');",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "What is the total amount of all invoices sent for projects in development?",
        "SQLQuery": "SELECT SUM(total_amount) AS total_amount_sent FROM invoice i LEFT JOIN project_basic pb ON i.project_id = pb.id WHERE pb.status LIKE '%development%' AND email_sent = 1;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "Which projects have invoices that are still unpaid?",
        "SQLQuery": "SELECT DISTINCT pb.name AS project_name FROM invoice i LEFT JOIN project_basic pb ON i.project_id = pb.id WHERE i.status != 3; -- 3 indicates fully paid",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "How many invoices were sent for each project in the last week?",
        "SQLQuery": "SELECT pb.name AS project_name, COUNT(*) AS total_invoices_sent FROM invoice i LEFT JOIN project_basic pb ON i.project_id = pb.id WHERE DATEDIFF(CURDATE(), i.createdAt) <= 7 GROUP BY pb.name;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "What are the details of the most recent invoice sent?",
        "SQLQuery": "SELECT i.title AS invoice_title, i.invoice_no AS invoice_number, i.createdAt AS invoice_created, pb.name AS project_name, pb.id AS project_id FROM invoice i LEFT JOIN project_basic pb ON i.project_id = pb.id WHERE email_sent = 1 ORDER BY i.createdAt DESC LIMIT 3;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "List all employees who worked on projects with overdue invoices.",
        "SQLQuery": "SELECT DISTINCT e.first_name, e.last_name FROM employee e INNER JOIN project_resource pr ON e.id = pr.employee_id INNER JOIN invoice i ON pr.project_id = i.project_id WHERE i.due_date < CURDATE() AND i.status != 3;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "Which projects have invoices that are partially paid and still have resources assigned to them?",
        "SQLQuery": "SELECT DISTINCT pb.name AS project_name FROM project_basic pb INNER JOIN invoice i ON pb.id = i.project_id INNER JOIN project_resource pr ON pb.id = pr.project_id WHERE i.status = 2;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "List all projects with invoices sent within the last month and the corresponding project resources.",
        "SQLQuery": "SELECT pb.name AS project_name, e.first_name AS resource_first_name, e.last_name AS resource_last_name FROM project_basic pb INNER JOIN invoice i ON pb.id = i.project_id INNER JOIN project_resource pr ON pb.id = pr.project_id INNER JOIN employee e ON pr.employee_id = e.id WHERE DATE_FORMAT(i.createdAt, '%Y-%m') = DATE_FORMAT(CURDATE() - INTERVAL 1 MONTH, '%Y-%m');",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "List all employees who have worked on projects that are signed off and have invoices overdue.",
        "SQLQuery": "SELECT DISTINCT e.first_name, e.last_name FROM employee e INNER JOIN project_resource pr ON e.id = pr.employee_id INNER JOIN project_basic pb ON pr.project_id = pb.id INNER JOIN invoice i ON pb.id = i.project_id WHERE pb.status = 'Signed off' AND i.due_date < CURDATE();",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "List the employees who joined the company after '2022-01-01' and are currently active.",
        "SQLQuery": "SELECT first_name, last_name, join_date FROM employee WHERE join_date > '2022-01-01' AND status = 2;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "List the employees who have a leave balance greater than 5.",
        "SQLQuery": "SELECT e.first_name, e.last_name FROM employee e JOIN leave_balance l ON e.id = l.employee_id WHERE l.balance > 5;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "Help me determine the average number of leaves taken by employees per month in the last quarter.",
        "SQLQuery": "SELECT AVG(leaves_taken) AS avg_leaves_per_month FROM ( SELECT COUNT(*) AS leaves_taken FROM leave_application WHERE from_date >= DATE_SUB(CURDATE(), INTERVAL 3 MONTH) GROUP BY MONTH(from_date) ) AS leaves_per_month;",
        "SQLResult": "",
        "Answer": "",
    },
    {
        "Question": "Tell me the names of employees who have not taken any leave in the past year.",
        "SQLQuery": "SELECT e.first_name, e.last_name FROM employee e LEFT JOIN leave_application la ON e.id = la.employee_id WHERE la.id IS NULL AND e.join_date <= DATE_SUB(CURDATE(), INTERVAL 1 YEAR);",
        "SQLResult": "",
        "Answer": "",
    },
    {
        ...
        "SQLQuery": "SELECT e.first_name, e.last_name FROM employee e JOIN leave_application la ON e.id = la.employee_id JOIN leave_balance lb ON e.id = lb.employee_id WHERE DATEDIFF(la.to_date, la.from_date) > 3 AND lb.balance < 5 LIMIT 5;",
        "SQLResult": "",
        "Answer": "",
    },
]
